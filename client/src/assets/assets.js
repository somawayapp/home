...
import housevid from "./housevid.webm"
import upcomingvid from "./upcomingvid.webm"
import agenticon from "./agenticon.jpg"
...
export const menuLinks = [
    { name: "Home", path: "/" },
    { name: "Cars", path: "/cars" },
    { name: "My requests", path: "/my-bookings" },
    { name: "My Favourites", path: "/my-bookings" },
    { name: "Helpcenter", path: "/my-bookings" },

]

export const ownerMenuLinks = [
    { name: "Dashboard", path: "/owner", icon: dashboardIcon, coloredIcon: dashboardIconColored },
    { name: "Add car", path: "/owner/add-listing", icon: addIcon, coloredIcon: addIconColored },
