  ...
  return (
    <>
      <motion.div
        ...
        className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between bg-white px-6 py-3 transition-colors duration-300 md:px-16 lg:px-24 xl:px-32 ${
