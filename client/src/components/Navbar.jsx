...
const Navbar = () => {
  ...
  return (
    <motion.div
      ...
      className={`sticky top-0 z-50 bg-white border-b border-light flex flex-col w-full overflow-x-hidden transition-all ${
        location.pathname === '/' ? 'bg-light' : ''
      }`}
    >
      {/* Navbar container */}
      <div className="flex items-center justify-between h-14 md:h-20 px-4 md:px-16 lg:px-24 xl:px-32">
        {/* Logo */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            {/* Toggle Button */}
            <button
              className="cursor-pointer border border-light rounded-full px-3 py-3 md:py-1 md:px-2 shadow-md hover:shadow-md flex items-center gap-3 z-50 relative"
              aria-label="Menu"
            ...
            <div
              ref={dropdownRef}
              className={`absolute top-14 right-0 w-55 max-w-[90vw] md:w-60 border pb-2 pt-1 border-light bg-white rounded-lg md:rounded-xl shadow-xl 
