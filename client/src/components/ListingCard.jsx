      ...
      <Link to={`/listing-details/${listing._id}`} className="block">
        <div className="relative w-full h-full aspect-[3/3] rounded-xl overflow-hidden">
          ...
          <div className={`absolute rounded-full bottom-3 right-3 px-3 py-1 text-white text-sm font-medium
            ${listing.listingstatus ? "bg-[#FF5A5F] hover:bg-[#ff4248]" : "bg-gray-500"}`}>
...
<div className="mt-3 gap-1">
  <Link to={`/listing-details/${listing._id}`} className="block">
    ...
    <div className="flex justify-between mr-1">
      <p className=" font-semibold capitalize text-[14px] md:text-[15px]">
    ...
    <p className="text-neutral-500 capitalize text-[14px] md:text-[15px]">
    ...
    {/* Phone Number */}
    {listing.agentphone && (
      <p className="text-neutral-500 text-[13px] md:text-[14px]">
