            ...
            return (
              <div
                ...
                className={`flex flex-col items-center justify-center cursor-pointer 
                  ...
                  ${
                    isActive
                      ? "text-neutral-500 after:block after:content-[''] after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[2px] after:bg-neutral-500"
                      : "text-[#A0A0A0] hover:text-neutral-500 hover:after:block hover:after:content-[''] hover:after:absolute hover:after:bottom-0 hover:after:left-0 hover:after:right-0 hover:after:h-[2px] hover:after:bg-neutral-500"
                  }`}
              >
