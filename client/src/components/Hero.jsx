  ...
  <div className="p-1 md:p-2">
   ...
   <motion.div
     ...
     >
        ...
        >
          <div className="flex flex-row items-center gap-4 " onClick={() => setShowModal(true)}>
            <div className="flex flex-col py-3 pr-14  pl-9 items-start rounded-full hover:bg-gray-100 transition-colors cursor-pointer">
            ...
            <div className="flex flex-col py-3 px-5 items-start rounded-full hover:bg-gray-100 transition-colors cursor-pointer">
