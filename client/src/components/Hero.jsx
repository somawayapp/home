    ...
    <div className="flex items-center justify-center w-full">
      ...
      >
        ...
        <div  onSubmit={handleSearch}
          className="hidden md:flex mt-5 mb-5 flex-row items-center justify-between rounded-full w-full max-w-850 bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)] border border-light"
        >
          <div className="flex flex-row items-center gap-[5%] ml-4" onClick={() => setShowModal(true)}>
