...
>
  ...
  >
    <div className="flex flex-row items-center w-full">
      ...
      <div className="group flex flex-row items-center flex-1">
        <div className="flex flex-col py-3 px-8 items-start rounded-l-full group-hover:bg-gray-100 transition-colors cursor-pointer w-full">
