   ...
   <motion.div
     ...
     >
        ...
        <div  onSubmit={handleSearch}
          className="hidden md:flex mt-5  w-full flex-row max-w-350 items-center justify-between rounded-full  bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)] border border-light"
        >
