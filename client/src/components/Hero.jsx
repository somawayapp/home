   ...
   <motion.div
     ...
     >
        ...
        <div  onSubmit={handleSearch}
          className="hidden md:flex mt-2  w-full flex-row max-w-205 items-center justify-between rounded-full  bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)] border border-light"
        >
          <div className="flex flex-row items-center gap-2 " onClick={() => setShowModal(true)}>
            <div className="flex flex-col py-3 pr-15  pl-9 items-start rounded-full hover:bg-gray-100 transition-colors cursor-pointer">
            ...
            <div className="flex flex-col py-3 px-6 items-start rounded-full hover:bg-gray-100 transition-colors cursor-pointer">
