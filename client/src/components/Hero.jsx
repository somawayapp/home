...
useEffect(() => {
  ...
  return (
    <div className="flex bg-white transition-colors duration-300 px-4 md:px-12 items-center justify-between 
  ...
  {links.map((link) => {
   ...
   <div className='flex items-center gap-4'>
        ...
        <div  onSubmit={handleSearch}
          className="hidden md:flex mt-5 mb-5 flex-row items-center justify-between rounded-full  bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)] border border-light"
        >
