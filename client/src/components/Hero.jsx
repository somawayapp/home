  ...
  >
    <div className="flex flex-row items-center w-full">
      ...
      <div className="flex flex-row items-center">
        ...
        {/* Right bar disappears when this group OR next group is hovered */}
        <span className="h-9 w-px bg-borderColor opacity-100 transition-opacity peer-hover:opacity-0" />
      </div>

      {/* === GROUP 2 === */}
      <div className="flex flex-row items-center">
        {/* Left bar disappears when prev group OR this group is hovered */}
        <span className="h-9 w-px bg-borderColor opacity-100 transition-opacity peer-hover:opacity-0" />
        ...
        {/* Right bar disappears on hover of this group */}
        <span className="h-9 w-px bg-borderColor opacity-100 transition-opacity peer-hover:opacity-0" />
      </div>
