...
useEffect(() => {
  ...
  return (
    <div className="flex  flex-col bg-white transition-colors duration-300 px-4 md:px-12 items-center justify-between 
...
<div className="flex flex-row w-full items-start py-5 justify-between">
 ...
 <div className=' hidden md:flex'>
  ...
  {/* === Links Section === */}
   ...
   {!isSmallScreen && showDesktop && location.pathname === "/" && (
    <div className='flex flex-col mt-[-2] w-full items-center justify-center'>
     ...
     >
        ...
        >
          <div className="flex flex-row items-center gap-4 ml-4" onClick={() => setShowModal(true)}>
            ...
            <div className="flex flex-col py-2 px-3 items-start rounded-full hover:bg-gray-100 transition-colors cursor-pointer">
