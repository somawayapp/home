     ...
     >
        ...
        >
          <div className="flex flex-row items-center gap-4 ml-4" onClick={() => setShowModal(true)}>
            <div className="flex flex-col py-2   px-[7%]  mr-9 items-start rounded-full hover:bg-gray-100 transition-colors cursor-pointer">
            ...
            <div className="flex flex-col py-2 px-[4%] items-start rounded-full hover:bg-gray-100 transition-colors cursor-pointer">
             ...
             <span className="h-10 w-px bg-gray-300"></span>
             <div className="flex flex-col py-2 px-[12%] items-start rounded-full hover:bg-gray-100 transition-colors cursor-pointer">
            ...
            <span className="h-10 w-px bg-gray-300"></span>
            <div className="flex flex-col py-2 px-[1%] items-start rounded-full hover:bg-gray-100 transition-colors cursor-pointer">
