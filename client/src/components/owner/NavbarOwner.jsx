...
const NavbarOwner = () => {
 ...
 viewBox="0 0 3490 1080" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Hodii logo">
  ...
  " fill="none" stroke="currentColor" stroke-width="85" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <p className='sm:text-12'>Welcome, {user?.name || "Owner"}</p>
      </div>


       <div className="relative w-full h-[45px] overflow-hidden">
        <div className="absolute inset-0 animate-gradient-move bg-[linear-gradient(90deg,#E61E4D,#E31C5F,#D70466,#E31C5F)]
