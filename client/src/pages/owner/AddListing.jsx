...
<div className="flex flex-col gap-3 w-full">
  ...
  <label
    ...
    className="flex items-center gap-2 border-4 border-[#FF5864] hover:border-[#FD297B] p-2 bg-bgColor rounded-xl cursor-pointer hover:bg-bgColorhover transition"
  >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              <div className="flex flex-col w-full">
                ...
                <input
                  ...
                  required
                  className="px-3 py-2 mt-1 border-2  border-gray-400  hover:border-[#FF5864] rounded-md outline-none focus:ring focus:ring-[#FD297B] hover:border-[#FF5864] rounded-md outline-none focus:ring focus:ring-[#FD297B]"
              ...
              <div className="flex flex-col w-full">
               <label className="font-semibold md:text-lg " >Agent Phone</label>
                <input
                  ...
                  required
                  className="px-3 py-2 mt-1 border-2  border-gray-400  hover:border-[#FF5864] rounded-md outline-none focus:ring focus:ring-[#FD297B]  rounded-md outline-none"
