...
<h1 className="py-3 text-[16px] md:text-[20px] font-medium text-neutral-900">
  Latest{" "}
...
/>
        ...
        {/* --- Listings Grid --- */}
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-7 gap-3 mx-auto">
      {/* --- Loading Preloaders --- */}
      {loading &&
  ...
  {/* optional inner skeleton content */}
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="h-4 bg-bgColor rounded w-1/2"></div>
              <div className="h-4 bg-bgColor rounded w-1/3"></div>
            </div>
                      </div>
