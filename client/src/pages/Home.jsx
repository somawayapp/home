    ...
    <div>
      ...
      {showModal && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="fixed inset-0 bg-black/20 flex items-center justify-center  py-4 md:py-9 z-50"
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-2xl p-4 md:p-9  w-full max-w-3xl border border-light shadow-xl max-h-[90vh] overflow-y-auto"
          >
