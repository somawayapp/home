...
// This is a placeholder for a real reverse geocoding function.
// You would replace this with an actual API call to a service like OpenStreetMap's Nominatim or BigDataCloud.
...
    if (address) {
      // Prioritize city, town, village, or a display name
      return address.city || address.town || address.village || data.display_name;
    }
    return "Unknown location";
  } catch (error) {
    console.error("Reverse geocoding failed:", error);
    return "Could not find location name";
  }
};
...
          handleFilterChange("location", locationName); // Populate the text box
          
...
                      handleFilterChange("lat", lat);
                      handleFilterChange("lng", lon);
...
                </div>
                ...
                <div className="flex gap-4 mt-2">
                    <input
                        ...
                        onChange={(e) => handleFilterChange(e.target.name, parseInt(e.target.value) || 0)}
                    ...
                    <input
                        ...
                        onChange={(e) => handleFilterChange(e.target.name, parseInt(e.target.value) || 1000000000)}
                        className="w-1/2 border rounded-lg p-2"
